...
- (instancetype)init {
  RuKorincCoreEntityQuery_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LRuKorincCoreEntityQuery;", 0x1, 9, 6, -1, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, -1, -1, -1, -1 },
  ...
  methods[2].selector = @selector(getOldResults);
  methods[3].selector = @selector(setOldResultsWithJavaUtilArrayList:);
  methods[4].selector = @selector(getPage);
  methods[5].selector = @selector(setPageWithInt:);
  methods[6].selector = @selector(getTitle);
  methods[7].selector = @selector(setTitleWithNSString:);
  methods[8].selector = @selector(setGenerationWithInt:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "oldResults_", "LJavaUtilArrayList;", .constantValue.asLong = 0, 0x2, -1, -1, 11, -1 },
  };
  static const void *ptrTable[] = { "ILNSString;", "()Ljava/util/ArrayList<Lru/korinc/core/entity/SearchEntity;>;", "setOldResults", "LJavaUtilArrayList;", "(Ljava/util/ArrayList<Lru/korinc/core/entity/SearchEntity;>;)Lru/korinc/core/entity/Query;", "setPage", "I", "setTitle", "LNSString;", "setGeneration", "toString", "Ljava/util/ArrayList<Lru/korinc/core/entity/SearchEntity;>;" };
  static const J2ObjcClassInfo _RuKorincCoreEntityQuery = { "Query", "ru.korinc.core.entity", ptrTable, methods, fields, 7, 0x1, 11, 4, -1, -1, -1, -1, -1 };
  return &_RuKorincCoreEntityQuery;
}

@end

void RuKorincCoreEntityQuery_init(RuKorincCoreEntityQuery *self) {
  NSObject_init(self);
  self->generation_ = -1;
  self->page_ = 1;
  self->title_ = @"";
...
RuKorincCoreEntityQuery *new_RuKorincCoreEntityQuery_init() {
  J2OBJC_NEW_IMPL(RuKorincCoreEntityQuery, init)
}

RuKorincCoreEntityQuery *create_RuKorincCoreEntityQuery_init() {
  J2OBJC_CREATE_IMPL(RuKorincCoreEntityQuery, init)
}
