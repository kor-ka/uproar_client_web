...
@interface RuKorincRuntimeRxObserverWrapper : NSObject

@end

@implementation RuKorincRuntimeRxObserverWrapper
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(RuKorincRuntimeRxObserverWrapper)
